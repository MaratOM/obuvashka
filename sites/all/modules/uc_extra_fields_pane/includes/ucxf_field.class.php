...
class ucxf_field {
  ...
  public function delete() {
    db_query("DELETE FROM {uc_extra_fields} WHERE field_id = %d", $this->field_id);

    // Let other modules react on this
    module_invoke_all('ucxf_field', $this, 'delete');
  }
  ...
  public function edit_form() {
    ...
    if (!empty($this->field_id)) {
      $form['ucxf']['field_id'] = array('#type' => 'hidden', '#value' => $this->field_id);
      drupal_set_title(t('Modify field: %name', array('%name' => $this->db_name)));
    }
