...
------------------------
by blackice78, panthar and MegaChriz
...
------------
Ubercart Addresses integration is on the way. At the time of this writing
(september 24, 2011) a first development version of Ubercart Addresses 
6.x-2.x has been released. This version of Extra Fields Pane is not yet
compatible with that version, but a future release will be.
