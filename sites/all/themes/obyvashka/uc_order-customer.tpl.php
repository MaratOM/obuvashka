<?php
// $Id: uc_order-customer.tpl.php 7867 2010-08-25 20:54:46Z jeremy $
...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#e8e8e8" style="font-family: verdana, arial, helvetica; font-size: small;">
  <tr>
    <td>
      <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" bgcolor="#F0F4D5" style="font-family: verdana, arial, helvetica; font-size: small;">
        ...
        <tr valign="top">
          <td>
            ...
            <p><b><?php echo t('Благодарим Вас за заказ, !order_first_name!', array('!order_first_name' => $order_first_name)); ?></b></p>
            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
              <tr>
                <td colspan="2" bgcolor="#e8e8e8" style="color: #0B4B70;">
              ...
              <tr>
                <td colspan="2" bgcolor="#EEEEEE">
                  <font color="#666666"><b><?php echo t('Shipping Details:'); ?></b></font>
                </td>
              </tr>
              <?php } ?>
              <tr>
                <td colspan="2" bgcolor="#EEEEEE">
                  <font color="#666666">Доставка по Москве в пределах МКАД - бесплатно (при условии совершения покупки).<br />При несостоявшейся покупке оплачивается выезд курьера - 200 руб.</font>
                </td>
              </tr>              
